...
mixin _$ProductDetail {
  @JsonKey(name: 'CPU')
  String get cpuName => throw _privateConstructorUsedError;
...
abstract class $ProductDetailCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'CPU') String cpuName,
      String camera,
...
class _$ProductDetailCopyWithImpl<$Res, $Val extends ProductDetail>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      cpuName: null == cpuName
          ? _value.cpuName
          : cpuName // ignore: cast_nullable_to_non_nullable
              as String,
      camera: null == camera
          ? _value.camera
...
/// @nodoc
@JsonSerializable()
class _$_ProductDetail with DiagnosticableTreeMixin implements _ProductDetail {
  const _$_ProductDetail(
      {@JsonKey(name: 'CPU') required this.cpuName,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProductDetail(cpuName: $cpuName, camera: $camera, capacity: $capacity, color: $color, id: $id, images: $images, isFavorites: $isFavorites, price: $price, rating: $rating, sd: $sd, ssd: $ssd, title: $title)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('cpuName', cpuName))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cpuName, cpuName) || other.cpuName == cpuName) &&
...
abstract class _ProductDetail implements ProductDetail {
  const factory _ProductDetail(
      {@JsonKey(name: 'CPU') required final String cpuName,
      ...
      required final String title}) = _$_ProductDetail;
